...
const Login = () => {
  ...
  const [validity, setValidity] = useState({ email: null, password: null });
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (isNewUser) {
        // User hasn't registered yet through our app
        await user.delete(); // Remove the automatically created account
  ...
  return (
    <div className="auth-body">
      ...
      <div className="welcome-showcase">
        <h1>Welcome Back, <span>Gamer</span></h1>
        <p className="subtitle">Jump back into your ultimate gaming experience. Over 10,000+ premium games await.</p>
      ...
      <div className="wrapper" style={{ zIndex: 1 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="social-login">
            <button type="button" className="social-btn steam" disabled={loading} onClick={handleGoogleSignIn}>
